...
// 根据场馆主键查询所有经营课程
const urlQueryCourseListByGymId = '/atpGym/queryCourseListByGymId.json'
// 查看详情
const urlQueryDetailById = '/atpGym/queryDetailById.json'
// 更新场馆
const urlUpdateGym = '/atpGym/updateGym.do'
// 场馆列表
