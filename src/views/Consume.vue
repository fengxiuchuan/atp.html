    ...
    <section>
        ...
        <el-table  :data="selectedCourseList" highlight-current-row border   style="width: 100%;"  size="small">
            ...
            <el-table-column label="执行教练"  >
                <template slot-scope="scope">
                    <el-select name="execCoachIdArr" v-model="selectedCourseList[scope.$index].execCoachIdArr" filterable placeholder="请选择" @change="coachChange(scope.$index, scope.row)" >
                        <el-option
            ...
            <el-table-column label="消耗课时">
                <template slot-scope="scope">
                    <el-input name="courseNum" v-model="selectedCourseList[scope.$index].totalNumArr" type="text" placeholder="请输入课时数" >
                    </el-input>
                </template>
            </el-table-column>
            <el-table-column label="积分">
                <template slot-scope="scope">
                    <el-input name="integralArr" v-model="selectedCourseList[scope.$index].courseAmountArr" type="text" placeholder="请输入课程费用" >
                   </el-input>
                </template>
            </el-table-column>
